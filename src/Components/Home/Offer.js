    ...
    <div className="container mx-auto grid grid-cols-3 gap-10 mt-20 gap-y-15">
      <div class=" flex justify-center items-center">
        <div class="flex flex-col justify-between w-80 sm:w-96 h-96 bg-black bg-center text-gray-800 shadow-md overflow-hidden cursor-pointer">
          <div class="flex justify-between items-center ml-4 pr-8">
            ...
            <div class="bg-red-600 w-12 h-14 shadow flex flex-col-reverse p-2 text-center font-bold text-white rounded-b-full">
              50%
            </div>
          </div>
          <div>
          ...
          <div class="bg-black bg-opacity-95 shadow-md rounded-r-xl p-4 flex flex-col mr-4 mb-8">
            <h3 class="text-xl font-bold pb-2 text-emerald-600">
              Price $ 4562
            </h3>
      ...
      <div class=" flex justify-center items-center">
        <div class="flex flex-col justify-between w-80 sm:w-96 h-96 bg-black bg-center text-gray-800 shadow-md overflow-hidden cursor-pointer">
          ...
          <div>
            <img
              src="https://imageio.forbes.com/specials-images/imageserve/5fd00ea644cd62376ce2b6c1/In-this-photo-illustration-a-13inch-Macbook-pro-seen---/960x0.jpg?format=jpg&width=960"
              alt=""
              className="h-56"
            />
          </div>
      ...
      <div class=" flex justify-center items-center">
        <div class="flex flex-col justify-between w-80 sm:w-96 h-96 bg-black bg-center text-gray-800 shadow-md overflow-hidden cursor-pointer">
          ...
          <div>
            <img
              src="https://consumer.huawei.com/content/dam/huawei-cbg-site/common/mkt/pdp/phones/mate40-pro/images/power/wireless.jpg"
              alt=""
              className="h-56 w-80"
            />
          </div>
